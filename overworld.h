...
uint16 Overworld_GetLinkMap16Coords(struct Point16U *xy);
uint8 Overworld_HandleLiftableTiles(struct Point16U *pt_arg);
uint8 Overworld_LiftingSmallObj(uint16 a, uint16 pos, uint16 y, struct Point16U pt);
int Overworld_SmashRockPile(bool down_one_tile, struct Point16U *pt);
uint8 SmashRockPile_fromLift(uint16 a, uint16 pos, uint16 y, struct Point16U pt);
