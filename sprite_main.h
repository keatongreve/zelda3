...
void SpriteDraw_Beamos_Eyeball(int k, struct PrepOamCoordsRet *info);
...
void SpriteDraw_GuardHead(int k, struct PrepOamCoordsRet *info, int spr_offs);
void SpriteDraw_BNCBody(int k, struct PrepOamCoordsRet *info, int spr_offs);
void SpriteDraw_BNCFlail(int k, struct PrepOamCoordsRet *info);
...
void SpriteDraw_BombGuard_Arm(int k, struct PrepOamCoordsRet *info);
...
void Guard_AnimateHead(int k, int oam_offs, const struct PrepOamCoordsRet *poc);
void Guard_AnimateBody(int k, int oam_idx, const struct PrepOamCoordsRet *poc);
void Guard_AnimateWeapon(int k, const struct PrepOamCoordsRet *poc);
...
void SpriteDraw_GuardSpear(int k, struct PrepOamCoordsRet *info, int spr_offs);
...
void SpriteDraw_Archer_Weapon(int k, int spr_offs, struct PrepOamCoordsRet *info);
...
void SpriteDraw_Pikit_Tongue(int k, struct PrepOamCoordsRet *info);
void SpriteDraw_Pikit_Loot(int k, struct PrepOamCoordsRet *info);
...
struct ProjectSpeedRet Swamola_ProjectVelocityTowardsTarget(int k);
...
void SpriteDraw_TrinexxRockHead(int k, struct PrepOamCoordsRet *info);
...
void ChattyAgahnim_Draw(int k, struct PrepOamCoordsRet *info);
void SpriteDraw_CutsceneAgahnimSpell(int k, struct PrepOamCoordsRet *info);
void Sprite_CutsceneAgahnim_Zelda(int k);
void AltarZelda_DrawBody(int k, struct PrepOamCoordsRet *info);
...
void SpriteDraw_Moldorm_Eyeballs(int k, struct PrepOamCoordsRet *info);
...
void SpriteDraw_KingHelmasaur_Eyes(int k, struct PrepOamCoordsRet *info);
void KingHelmasaurMask(int k, struct PrepOamCoordsRet *info);
void KingHelmasaur_CheckBombDamage(int k, int j);
void SpriteDraw_KingHelmasaur_Body(int k, struct PrepOamCoordsRet *info);
void SpriteDraw_KingHelmasaur_Legs(int k, struct PrepOamCoordsRet *info);
void SpriteDraw_KingHelmasaur_Mouth(int k, struct PrepOamCoordsRet *info);
void KingHelmasaur_OperateTail(int k, struct PrepOamCoordsRet *info);
...
void SpriteDraw_StalfosKnight_Head(int k, struct PrepOamCoordsRet *info);
...
void Terrorpin_SetUpHammerHitBox(int k, struct SpriteHitBox *hb);
...
void YellowStalfos_DrawHead(int k, struct PrepOamCoordsRet *info);
...
bool PlayerBee_FindTarget(int k, struct Point16U *pt);
void Bee_Bzzt(int k);
